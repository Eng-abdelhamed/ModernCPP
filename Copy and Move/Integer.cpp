...
Integer::Integer(int Val) { m_int = new int(Val); }
...
void Integer::setInteger(int Val) { *m_int = Val; }

int Integer::getValue(void) const { return *m_int; }
